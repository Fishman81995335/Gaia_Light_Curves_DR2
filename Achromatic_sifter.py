...
# creates 3 files
# 1) Creates 'results.csv' in code directory with the results of the events
# that passed given cut offs
# 2) Creates 'RP_results.csv' in code directory with all RP events
# 3) Creates 'BP_results.csv' in code directory with all BP events
